...
def getfnative_cli(
    ...
    range_dim: Annotated[tuple[int, int] | None, range_dimension_opt] = None,
    dim_mode: Annotated[Literal["height", "width"], dimension_mode_opt] = "height",
    ...
    _show_builtin_kernels: Annotated[bool, show_builtin_kernels_opt] = False,
